...
#'
#' @param textkey a list (or vector) of character keys using the "--" delimiter to indicate heirarchy
#' @return A list of unnamed lists, with position in the nested list indicating heirarchy
#'
#' @examples
#' safetyGraphics:::textKeysToList("id_col") #list(list("id_col"))
#' safetyGraphics:::textKeysToList(c("id_col","measure_col--label") #list(list("id_col"),list("measure_col","label"))
#'
