...
checkField <- function(fieldKey, settings, data, dmeta){
  ...
  if(is.numeric(lastKey)){
    ...
    columnTextKey <-getSettingsMetadata(cols="field_column_key",text_keys=sub_text_key, dmeta=dmeta)
  }else{
    columnTextKey <-getSettingsMetadata(cols="field_column_key",text_keys=fieldCheck$text_key, dmeta=dmeta)
  }
