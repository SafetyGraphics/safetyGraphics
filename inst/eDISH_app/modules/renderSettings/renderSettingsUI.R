   ...
   #   splitLayout(
      verticalLayout(
        tagList(
          fluidRow(
            column(6, 
                   checkboxInput(ns("show_data_mapping"), "Data Mapping", FALSE),
                   checkboxInput(ns("show_measure_settings"), "Measure Settings", FALSE),
                   checkboxInput(ns("show_appearance_settings"), "Appearance Settings", FALSE))
          ),
                           ...
                           wellPanel(
                             fluidRow(
                               column(6,
                                      ...
                                      conditionalPanel(condition="input.measure_col != ''",  ns=ns, 
                                        div(
