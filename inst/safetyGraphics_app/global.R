...
# Source our tidy modules
source("modules_tidy/DataUpload.R")
source("modules_tidy/RenderSettings.R")
source("modules_tidy/RenderChart.R")
source("modules_tidy/RenderReports.R") 
source("modules_tidy/ChartStore.R") 

# 
DataUpload$new("datatab")
RenderSettings$new("settingsUI")
RenderReports$new("reports")
Store$new("modstore")
ChartStore$new("chartstore")

for(chart in all_charts){
  RenderChart$new(paste0("chart", chart), group="charts")
}