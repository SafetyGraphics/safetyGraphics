#######################################################
#
# Tests upload of data with no standard. 
# Chart and settings should fail.
#
#######################################################


app <- ShinyDriver$new("../")
app$snapshotInit("noStandard")

#Upload parital_SDTM ADBDS file from viz-library
app$uploadFile(`datatab-datafile` = "noStandard.csv") 

# Give it time to load file
Sys.sleep(5) 

#Select the newly uploaded ADBDS file
app$setInputs(`datatab-select_file` = "noStandard.csv")
