...
safetyGraphics supports a wide range of data formats and standards. Generally speaking, any clinical data can be loaded as long it meets the minimal data requirements described in [appendix 2](Intro#appendix-2---minimum-data-requirements).  
...
This example and other use cases are described in [cookbook vignette](cookbook).
...
- [Chart Configuration Vignette](ChartConfiguration) - details about the charting process including technical specifications and step-by-step instructions
- [Cookbook Vignette](Cookbook) - a series of examples showing how to initialize the safetyGraphics Shiny app in different scenarios
- [Technical FAQ Vignette](TechnicalFAQ) - vignette discussing security, validation and other technical issues
